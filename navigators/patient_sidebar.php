...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu">
            <div class="menu-items" onclick="setMenuActive(this)"><a href="../patient/patient_dashboard.php">Dashboard</a></div>
            ...
            <div class="collapsible-content" id="appointments">
                <div class="sub-menu-item" onclick="setActive(this)"><a href="../patient/patient_appointment.php">My Appointments</a></div>
                <div class="sub-menu-item" onclick="setActive(this)"><a href="../patient/patient_appointment_history.php">Appointment History</a></div>
                <div class="sub-menu-item" onclick="setActive(this)"><a href="../patient/patient_followup_request.php">Followup Request</a></div>
                <!-- <div class="sub-menu-item" onclick="setActive(this)"><a href="../admin/admin_appointments_history.php">Appointments History</a></div> -->
            </div>
            <div class="menu-items" onclick="setMenuActive(this)"><a href="../patient/patient_profile.php">Profile</a></div>
        </div>
    </div>
