    ...
    <div class="content">
        ...
        <div class="container d-flex justify-content-between">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="patient" value="ex. John Light Smith" disabled>
            </div>
            <div class="mb-3">
                <label for="patient" class="form-label">Followup Details For:</label>
                <input type="text" class="form-control" id="patient" value="ex. Braces" disabled>
            </div>
            <div class="mb-3">
                <label for="patient" class="form-label">Service Total Amount:</label>
                <input type="text" class="form-control" id="patient" value="ex. &#8369 30,000" disabled>
            </div>
        </div>
