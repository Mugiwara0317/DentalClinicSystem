        ...
        <table id="myTable">
            ...
            <tbody id="table-body">
                <tr>
                    ...
                    <td>Online</td>
                    <td>
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#followupModal" disabled>Followup</button>
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                    ...
                    <td>Walk-in</td>
                    <td>
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#followupModal">Followup</button>
                    </td>
                </tr>
                <tr>
                    <td>3</td>
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="amount" value="" disabled>
